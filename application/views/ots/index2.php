...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/assets/flatdream/js/jquery.nanoscroller/nanoscroller.css" />
  	...
  	<link rel="stylesheet" type="text/css" href="/assets/flatdream/js/jquery.datatables/bootstrap-adapter/css/datatables.css" />
          ...
          <ul class="cl-vnavigation">
            ...
            <li><a href="#"><i class="fa fa-table"></i><span>Tables</span></a>
              <ul class="sub-menu">
                ...
                <li class="active" ><a href="tables-datatables.html">Data Tables</a></li>
              </ul>
            </li>
